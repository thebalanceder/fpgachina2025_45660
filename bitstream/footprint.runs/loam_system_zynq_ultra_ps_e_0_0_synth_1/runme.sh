...
HD_PWD='C:/Users/USER-PC/footprint/footprint.runs/loam_system_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loam_system_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loam_system_zynq_ultra_ps_e_0_0.tcl
