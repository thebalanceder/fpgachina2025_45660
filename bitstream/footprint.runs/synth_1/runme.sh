...
HD_PWD='C:/Users/USER-PC/footprint/footprint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loam_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loam_system_wrapper.tcl
